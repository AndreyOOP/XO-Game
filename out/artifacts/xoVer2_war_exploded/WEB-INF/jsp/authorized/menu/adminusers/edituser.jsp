    ...
    <div class="col-md-4" >
        <form class="form-horizontal" action="/edituser" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="col-md-9" >
                    <input type="text" name="editName" class="form-control" readonly="true" id="inputUserName" placeholder="User Name" value="${SavedName}">
                ...
                <div class="col-md-9 col-md-offset-3">
                    <a class="btn btn-default" onclick="hideEditForm()">Cancel</a>
