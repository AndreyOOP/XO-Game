...
<div class="row">
    <div class="col-md-4" >
        <form class="form-horizontal" action="/editrecord" method="POST">
            <fieldset>
                <legend><h3>Edit statistic record :</h3></legend>

                <label for="inputUserName" class="col-md-3 control-label">User Name</label>
                <div class="col-md-9" >
                    <input type="text" name="formUserName" readonly="true" class="form-control" id="inputUserName" placeholder="User Name" value="${Admin_Stat_Saved_UserName}">
                ...
                <input type="hidden" class="form-control" name="recordId" value="${recordId}">

                <div class="col-md-9 col-md-offset-3">
                    <a class="btn btn-default" onclick="hideEditForm1()">Cancel</a>
